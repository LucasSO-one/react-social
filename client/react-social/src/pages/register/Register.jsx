...
export default function Register() {
  ...
  const handleClick = async (e) =>{
    ...
    if(passwordAgain.current.value !== password.current.value){
      passwordAgain.current.setCustomValidity("the passwords don't match")
    }else{
      const user = {
    ...
    <div className='login'>
        <div className="loginWrapper">
            <div className="loginLeft">
                ...
                <span className="loginDesc">Connect with friends and the world around you on Social Network</span>
